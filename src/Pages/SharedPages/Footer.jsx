        ...
        <footer className="bg-gray-800 text-white py-10">
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
                <div className="flex items-center mb-4 md:mb-0">
                    <img src="https://i.ibb.co/V24V2tB/314948-removebg-preview.png" alt="Logo" className="w-16 h-16 mr-2" />
                    <h1 className="text-xl font-bold">JobHunt</h1>
                </div>
                <div className="flex flex-wrap space-x-8 md:space-x-12">
                ...
                <div className="flex space-x-4">
                    <img
                        ...
                        alt="Facebook Icon"
                        className="w-6 h-6 cursor-pointer text-gray-300 hover:text-white transition duration-300 ease-in-out"
                    />
                    <img
